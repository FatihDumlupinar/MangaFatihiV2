...
{
    public class SeriesGetListWithFilterQueryHandler : IRequestHandler<SeriesGetListWithFilterQuery, DataResult<SeriesGetListWithFilterQueryDto>>
    {
        #region Ctor&Fields
        ...
        public async Task<DataResult<SeriesGetListWithFilterQueryDto>> Handle(SeriesGetListWithFilterQuery request, CancellationToken cancellationToken)
        {
