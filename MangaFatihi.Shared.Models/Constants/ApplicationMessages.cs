namespace MangaFatihi.Shared.Models.Constants
{
    /// <summary>
    ...
    public static class ApplicationMessages
    {
        ...
        public static Dictionary<string, string> Messages { get; set; } = new()
        {
            ...
            { ErrorLargeFile, "Belirlenen maksimum dosya boyutundan ( \'{0}\' byte ) daha büyük dosya!" },
        ...
        {
            //Eğer mesaj kodu varsa, mesajı döndür, yoksa boş string döndür.
            return Messages.TryGetValue(messageCode, out var result) ? result : "";
        }
