...
{
    public class GetSeriesInformationQueryHandler : IRequestHandler<GetSeriesInformationQuery, DataResult<GetSeriesInformationQueryDto>>
    {
        #region Ctor&Fields
        ...
        public async Task<DataResult<GetSeriesInformationQueryDto>> Handle(GetSeriesInformationQuery request, CancellationToken cancellationToken)
        {
