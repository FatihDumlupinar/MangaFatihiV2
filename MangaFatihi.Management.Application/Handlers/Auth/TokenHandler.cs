    ...
    public class TokenHandler : ITokenHandler
    {
        ...
        public async Task<TokenModel> CreateAccessTokenAsync(AppUser appUser, string? ipAddress, CancellationToken cancellationToken = default)
        {
            var authClaims = new List<Claim>
                {
                    ...
                    new Claim(PolicyTypes.UserFullNameClaimTypeName, appUser.FullName ?? ""),
            ...
            foreach (var userRole in userRoles)
            {
                ...
                authClaims.Add(new Claim(PolicyTypes.RoleClaimTypeName, userRole));
                ...
                permissionClaims = roleClaims.Where(i => i.Type == PolicyTypes.PermissionClaimTypeName).ToList();
