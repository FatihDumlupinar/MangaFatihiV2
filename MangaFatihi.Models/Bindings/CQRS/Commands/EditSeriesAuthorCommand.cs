...
public class EditSeriesAuthorCommand : ICommand<DataResult<object>>
{
    /// <summary>
...
public class EditSeriesAuthorCommandValidator : AbstractValidator<EditSeriesAuthorCommand>
{
    public EditSeriesAuthorCommandValidator()
    {
        RuleFor(x => x.Id)
